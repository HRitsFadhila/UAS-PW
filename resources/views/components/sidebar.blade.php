<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown ">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Registrasi</span></a>
                <ul class="dropdown-menu">
                    <li>
                        <a class="nav-link" href="{{ route('registrasi.index') }}">Registrasi List</a>
                    </li>
                </ul>
            </li>
            {{-- <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="nav-link" href="{{ route('biodata.index') }}">Biodata List</a>
                    </li>
                </ul>
            </li> --}}
    </aside>
